...
- [2] A frozen page's own script, read: alo's own service worker, in the corpus beside the pages, so what the lexer is judged against is a real script somebody wrote for a different purpose rather than examples written to match the code
